...
if (!needToLoadForm())
{
   ...
   if ($request->outputAsCSV || $request->outputAsSimpleCSV)
   {
      ...
      $formatter->buildCSV($request, $results, $request->outputAsSimpleCSV, true);
   }
   else
   {
      ...
      $formatter->buildHTML($request, $results, $numberOfPlayersDisplayed, $queryString, false, true, $debugMode);
      buildEndHTML();
   }
...
function processRequest($request, $isHTMLOutput)
{
   ...
   $results->hittersOutput = $builder->buildPointsValues($results->hitters, $request->hittersInput);

   $progress->updateProgress("Building values (Pitchers)...", $isHTMLOutput);

   // Build the values for pitchers
   $builder = new ValuesBuilder();
   $results->pitchersOutput = $builder->buildPointsValues($results->pitchers, $request->pitchersInput);
...
<body class="points" onload="showTable('hitters');">

<div class="extra_wide_top">
   <h1 class="points"><a href="http://lastplayerpicked.zxq.net">Last Player Picked</a></h1>
</div>
...
<p>If you are in a <strong>rotisserie</strong> league, there is a separate <a href="index.php">Rotisserie League</a> version of the Price Guide that can handle your league setup.</p>
...
<div class="item_head_wide">League Settings (Points)</div>
<div class="item_wide">
...
<label><a href="upload.php">Let me upload my own projections</a></label><br />
</div>

<div class="container">

<div id="hitter_points">
   <div class="item_head">Batting Categories</div>
   <div class="item">
      <label><span class="narrow"><input type="text" id="AB" name="AB" value="0" size="1" /></span> AB</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="R" name="R" value="2" size="1" /></span> R</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="RBI" name="RBI" value="2" size="1" /></span> RBI</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="HR" name="HR" value="4" size="1" /></span> HR</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="SB" name="SB" value="2" size="1" /></span> SB</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="CS" name="CS" value="0" size="1" /></span> CS</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="H" name="H" value="0.5" size="1" /></span> H</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="BB" name="BB" value="0" size="1" /></span> BB</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="DB" name="DB" value="0" size="1" /></span> 2B</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="TP" name="TP" value="0" size="1" /></span> 3B</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="SO" name="SO" value="0" size="1" /></span> K</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="HBP" name="HBP" value="0" size="1" /></span> HBP</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="SH" name="SH" value="0" size="1" /></span> SH</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="SF" name="SF" value="0" size="1" /></span> SF</label><br class="clear"/>
   </div>
</div>

<div id="pitcher_points">
   <div class="item_head">Pitching Categories</div>
   <div class="item">
      <label><span class="narrow"><input type="text" id="IP" name="IP" value="1" size="1" /></span> IP</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="W" name="W" value="5" size="1" /></span> W</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="L" name="L" value="0" size="1" /></span> L</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="S" name="S" value="5" size="1" /></span> S</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="K" name="K" value="2" size="1" /></span> K</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="ER" name="ER" value="-0.5" size="1" /></span> ER</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="PBB" name="PBB" value="0" size="1" /></span> BB</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="PH" name="PH" value="0" size="1" /></span> H</label><br class="clear"/>
      <label><span class="narrow"><input type="text" id="PHR" name="PHR" value="0" size="1" /></span> HR</label><br class="clear"/>
   </div>
</div>
